...
if __name__=="__main__":
    ...
    if load_pretrained:
        encoder_path = '/home/jwells/Documents/BetaVAEImputation/output/non_masked_beta50_lr1e-05/epoch_1000_loss_14374.0/encoder.keras'
        decoder_path = '/home/jwells/Documents/BetaVAEImputation/output/non_masked_beta50_lr1e-05/epoch_1000_loss_14374.0/decoder.keras'
    ...
    for i in range(20):
        ...
        if i > 1:
            ...
            outdir = model_savepath + f"epoch_{(i+1)*epochs+1000}_loss_{loss}/"
