...
if __name__=="__main__":
    ...
    mult_imp_datasets, effective_sample = model.impute_multiple(data_corrupt=data_missing, max_iter=5, m = 4, method = 'importance sampling2')
    ...
    for imputed_dataset in mult_imp_datasets:
        multi_imputes.append(imputed_dataset[na_ind])
